...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversItemsOn200HTPPResponseWithJSONItems() {
        let (sut, client) = makeSUT()
    ...
    private func makeSUT(url: URL = URL(string: "aURL.com")!, file: StaticString = #file, line: UInt = #line) -> (sut: RemoteFeedLoader, client: HTTPClientSpy) {
